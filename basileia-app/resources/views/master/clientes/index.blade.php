...
<div class="page-header animate-in">
    <div>
        <h2>👥 Clientes da Operação</h2>
        <div class="subtitle">Gestão centralizada e carteira de igrejas/entidades</div>
    </div>
</div>
...
<div class="filters-bar animate-in">
    <div class="filter-group" style="flex: 2;">
        <label>Buscar Igreja, Pastor ou CNPJ</label>
        <input type="text" name="busca" value="{{ request('busca') }}" placeholder="Ex: Igreja Batista...">
    </div>
    ...
    <div style="display: flex; gap: 8px; align-items: flex-end;">
        ...
        <a href="{{ route('master.clientes') }}" style="text-decoration: none; font-size: 0.85rem; color: var(--text-muted); font-weight: 600; padding: 10px;">Limpar</a>
    </div>
</div>
</form>
...
<div class="table-container animate-in">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="font-family: monospace; color: var(--text-muted);">{{ $c->documento ?? 'Não informado' }}</td>
                <td style="font-weight: 700; text-align: center;">{{ $c->quantidade_membros ?? '-' }}</td>
                <td style="text-align: center; font-weight: 700; color: var(--primary);">{{ $c->vendas->count() }}</td>
                <td>
    ...
    <div style="padding: 80px 20px; text-align: center;">
        ...
        <h3 style="color: var(--text-main); font-weight: 700; margin-bottom: 8px;">Nenhum cliente encontrado</h3>
        <p style="color: var(--text-muted); font-size: 0.95rem;">Experimente alterar os filtros de busca para encontrar o que procura.</p>
    </div>
    @endif
</div>
