@extends('layouts.app')
@section('title', 'Comissões da Operação')
...
<div class="page-header animate-in">
    <div>
        <h2>💰 Comissões da Operação</h2>
        <div class="subtitle">Gestão de comissões por vendedor e período</div>
    </div>
    <div style="display: flex; gap: 10px;">
        <a href="{{ route('master.comissoes.exportar', ['mes' => $mes, 'vendedor_id' => $vendedorId]) }}" class="btn-export">
            📥 Exportar Excel
        </a>
    </div>
</div>
...
<div class="filters-bar animate-in">
    ...
    <div style="display: flex; gap: 8px; align-items: flex-end;">
        ...
        <a href="{{ route('master.comissoes') }}" style="text-decoration: none; font-size: 0.85rem; color: var(--text-muted); font-weight: 600; padding: 10px;">Limpar</a>
    </div>
</div>
</form>
...
<div class="table-container animate-in">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <td style="font-weight: 600;">{{ $c->vendedor->user->name ?? 'N/A' }}</td>
                <td>
    ...
    <div style="padding: 80px 20px; text-align: center;">
        ...
        <p style="color: var(--text-muted); font-size: 0.95rem;">As comissões aparecerão aqui quando os pagamentos forem confirmados.</p>
    </div>
    @endif
</div>
